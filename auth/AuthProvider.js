    ...
    handleRedirect(options = {}) {
        return async (req, res, next) => {
            ...
            const authCodeRequest = {
                ...
                code: req.body.code,
                codeVerifier: req.session.pkceCodes.verifier || 'OWtMNGs2R3BPfmJ1WC56al8zdTItbnpESnhtUDRlVWtv',
    ...
    redirectToAuthCodeUrl(authCodeUrlRequestParams, authCodeRequestParams, msalInstance) {
        return async (req, res, next) => {
            ...
            req.session.pkceCodes = {
                ...
                verifier: verifier || 'OWtMNGs2R3BPfmJ1WC56al8zdTItbnpESnhtUDRlVWtv',
                challenge: challenge ,
            };
